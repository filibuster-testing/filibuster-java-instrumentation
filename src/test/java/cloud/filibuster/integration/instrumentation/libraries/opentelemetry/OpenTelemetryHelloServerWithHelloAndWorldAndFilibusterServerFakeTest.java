...
public class OpenTelemetryHelloServerWithHelloAndWorldAndFilibusterServerFakeTest extends HelloServerTest {
    ...
    public void testWorldOtelExternalWithFilibuster() {
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-a88bf75c73a7bb600808291dc7f5f2a67d7d6be4-0b2c7a3d6d82ede9ae2958a787ce2639af116476\", 1]]", firstInvocationPayload.getString("execution_index"));
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-a88bf75c73a7bb600808291dc7f5f2a67d7d6be4-0b2c7a3d6d82ede9ae2958a787ce2639af116476\", 1]]", firstRequestReceivedPayload.getString("execution_index"));
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-a88bf75c73a7bb600808291dc7f5f2a67d7d6be4-0b2c7a3d6d82ede9ae2958a787ce2639af116476\", 1]]", firstInvocationCompletePayload.getString("execution_index"));
    ...
    public void testWorldOtelExternalOtelWithFilibuster() {
        ...
        JSONObject firstInvocationPayload = FilibusterServerFake.payloadsReceived.get(0);
        assertEquals("invocation", firstInvocationPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-aa0f963bb50cc498ebe3c57aa86eef1c97b286f0-1a01d86894fc54286fb250d8dc0cf83a28aac139\", 1]]", firstInvocationPayload.getString("execution_index"));
        assertEquals(firstRequestVectorClock.toJSONObject().toString(), firstInvocationPayload.getJSONObject("vclock").toString());

        JSONObject firstRequestReceivedPayload = FilibusterServerFake.payloadsReceived.get(1);
        assertEquals("request_received", firstRequestReceivedPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-aa0f963bb50cc498ebe3c57aa86eef1c97b286f0-1a01d86894fc54286fb250d8dc0cf83a28aac139\", 1]]", firstRequestReceivedPayload.getString("execution_index"));

        JSONObject secondInvocationPayload = FilibusterServerFake.payloadsReceived.get(2);
        assertEquals("invocation", secondInvocationPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-aa0f963bb50cc498ebe3c57aa86eef1c97b286f0-1a01d86894fc54286fb250d8dc0cf83a28aac139\", 1], [\"V1-7c211433f02071597741e6ff5a8ea34789abbf43-bf801c417a24769c151e3729f35ee3e62e4e04d4-60c35754561025cfd6a26701f03f4dcdeedfe6d3-0a33c850b8b1834c9e7ec64a7afa9982c6f092da\", 1]]", secondInvocationPayload.getString("execution_index"));
        assertEquals(secondRequestVectorClock.toJSONObject().toString(), secondInvocationPayload.getJSONObject("vclock").toString());

        JSONObject secondInvocationCompletePayload = FilibusterServerFake.payloadsReceived.get(3);
        assertEquals("invocation_complete", secondInvocationCompletePayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-aa0f963bb50cc498ebe3c57aa86eef1c97b286f0-1a01d86894fc54286fb250d8dc0cf83a28aac139\", 1], [\"V1-7c211433f02071597741e6ff5a8ea34789abbf43-bf801c417a24769c151e3729f35ee3e62e4e04d4-60c35754561025cfd6a26701f03f4dcdeedfe6d3-0a33c850b8b1834c9e7ec64a7afa9982c6f092da\", 1]]", secondInvocationCompletePayload.getString("execution_index"));
        assertEquals(secondRequestVectorClock.toJSONObject().toString(), secondInvocationCompletePayload.getJSONObject("vclock").toString());

        JSONObject firstInvocationCompletePayload = FilibusterServerFake.payloadsReceived.get(4);
        assertEquals("invocation_complete", firstInvocationCompletePayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-bf801c417a24769c151e3729f35ee3e62e4e04d4-aa0f963bb50cc498ebe3c57aa86eef1c97b286f0-1a01d86894fc54286fb250d8dc0cf83a28aac139\", 1]]", firstInvocationCompletePayload.getString("execution_index"));
        assertEquals(firstRequestVectorClock.toJSONObject().toString(), firstInvocationCompletePayload.getJSONObject("vclock").toString());
    }
}
