...
public class JUnitFilibusterTestWithLatencyProfileAndLatencyInjection extends JUnitAnnotationBaseTest {
    ...
    @TestWithFaultInjection(analysisConfigurationFile=FilibusterLatencyOnlyAnalysisConfigurationFile.class, latencyProfile=Filibuster1000msLatencyProfile.class)
    @Order(1)
