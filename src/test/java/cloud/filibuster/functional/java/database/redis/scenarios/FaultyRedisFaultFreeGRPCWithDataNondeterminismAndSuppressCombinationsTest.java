...
public class FaultyRedisFaultFreeGRPCWithDataNondeterminismAndSuppressCombinationsTest extends JUnitAnnotationBaseTest {
    static StatefulRedisConnection<String, String> statefulRedisConnection;
    static String redisConnectionString;
    private static final Logger logger = Logger.getLogger(FaultyRedisFaultFreeGRPCWithDataNondeterminismAndSuppressCombinationsTest.class.getName());
