package cloud.filibuster.functional.java.database.redis.scenarios;
...
public class FaultyRedisFaultFreeGRPCWithSuppressCombinationsTest extends JUnitAnnotationBaseTest {
    static StatefulRedisConnection<String, String> statefulRedisConnection;
    static String redisConnectionString;
    private static final Logger logger = Logger.getLogger(FaultyRedisFaultFreeGRPCWithSuppressCombinationsTest.class.getName());
    ...
    @DisplayName("Tests the scenario where faults are injected in Redis, while the GRPC client before and after the Redis call " +
            "is fault-free. Data nondeterminism is false, while suppressCombinations is true")
    @Order(1)
    @TestWithFilibuster(
    ...
    public void testNumberOfExecutions() {
        ...
        // Since suppressCombinations is true and Redis get is called 3 times, this leads to 1 reference execution + 4*3 = 13 executions
        assertEquals(13, numberOfExecution);
    }
