...
public class HelloGrpcServerTestWithHelloAndWorldAndFilibusterServerFakeTest extends HelloGrpcServerTest {
    ...
    public void testMyHelloAndMyWorldServiceWithFilibuster() throws InterruptedException {
        MyHelloService.shouldUseDecorator = true;
        FilibusterClientInterceptor.disableInstrumentation = false;
        FilibusterServerInterceptor.disableInstrumentation = false;
        FilibusterDecoratingHttpClient.disableInstrumentation = false;
        ...
        assertEquals("DATA_LOSS: io.grpc.StatusRuntimeException: UNAVAILABLE: Injected fault from Filibuster, status code: 14", re.getMessage());
        ...
        FilibusterServerInterceptor.disableInstrumentation = true;
        FilibusterDecoratingHttpClient.disableInstrumentation = true;
        MyHelloService.shouldUseDecorator = false;
    }
    ...
    public void testMyHelloAndMyWorldServiceWithFilibusterParallelNoFault() throws InterruptedException {
        ...
        validDistributedExecutionIndexes.add("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-308d1419e1ba0da4af15c810881dec2f4c11dba9-6550c6956ce85982ca3b4a1bfb4341d3a3b4cd0d-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]");
        validDistributedExecutionIndexes.add("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-308d1419e1ba0da4af15c810881dec2f4c11dba9-6550c6956ce85982ca3b4a1bfb4341d3a3b4cd0d-32695a1108625346a7ea2158439d36cd0396aee3\", 1]]");
    ...
    public void testMyHelloAndMyWorldServiceVerifyRendezvous() throws InterruptedException {
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-308d1419e1ba0da4af15c810881dec2f4c11dba9-bf2e37f662587294c6c6468358da16c232f42fcc-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationPayload.getString("execution_index"));
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-308d1419e1ba0da4af15c810881dec2f4c11dba9-bf2e37f662587294c6c6468358da16c232f42fcc-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstRequestReceivedPayload.getString("execution_index"));
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-308d1419e1ba0da4af15c810881dec2f4c11dba9-bf2e37f662587294c6c6468358da16c232f42fcc-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationCompletePayload.getString("execution_index"));
        assertEquals(firstRequestVectorClock.toJSONObject().toString(), firstInvocationPayload.getJSONObject("vclock").toString());
    ...
    public void testMyHelloAndMyWorldServiceExternalHttpRoute() throws InterruptedException {
        ...
        JSONObject firstInvocationPayload = FilibusterServerFake.payloadsReceived.get(0);
        assertEquals("invocation", firstInvocationPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-07b1a0d6b1748a4e44384cce19bb13bb84b70289-c5ae426c0e338b03f750b8963fd3010cee50be0a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationPayload.getString("execution_index"));
        assertEquals(firstRequestVectorClock.toJSONObject().toString(), firstInvocationPayload.getJSONObject("vclock").toString());
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-07b1a0d6b1748a4e44384cce19bb13bb84b70289-c5ae426c0e338b03f750b8963fd3010cee50be0a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationRequestReceivedPayload.getString("execution_index"));
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-07b1a0d6b1748a4e44384cce19bb13bb84b70289-c5ae426c0e338b03f750b8963fd3010cee50be0a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1], [\"V1-7c211433f02071597741e6ff5a8ea34789abbf43-bf801c417a24769c151e3729f35ee3e62e4e04d4-97094b6a010685cf94ff6050f3e7d47808fad43b-0a8127ad87a9ab6630533750add635c52d003488\", 1]]", secondInvocationPayload.getString("execution_index"));
        ...
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-07b1a0d6b1748a4e44384cce19bb13bb84b70289-c5ae426c0e338b03f750b8963fd3010cee50be0a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1], [\"V1-7c211433f02071597741e6ff5a8ea34789abbf43-bf801c417a24769c151e3729f35ee3e62e4e04d4-97094b6a010685cf94ff6050f3e7d47808fad43b-0a8127ad87a9ab6630533750add635c52d003488\", 1]]", secondInvocationCompletePayload.getString("execution_index"));
        ...
        assertEquals("invocation_complete", firstInvocationCompletePayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-07b1a0d6b1748a4e44384cce19bb13bb84b70289-c5ae426c0e338b03f750b8963fd3010cee50be0a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationCompletePayload.getString("execution_index"));
    ...
    public void testMyHelloAndMyWorldServiceExternalGrpcRoute() throws InterruptedException {
        ...
        JSONObject firstInvocationPayload = FilibusterServerFake.payloadsReceived.get(0);
        assertEquals("invocation", firstInvocationPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-623ea48b2fcd64aa41a188f486cbce10d11817db-4e2178d1d6a088d306ed40e1c773a618a767d36a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationPayload.getString("execution_index"));
        assertEquals(firstRequestVectorClock.toJSONObject().toString(), firstInvocationPayload.getJSONObject("vclock").toString());
        firstInvocationPayload = null;

        JSONObject firstInvocationRequestReceivedPayload = FilibusterServerFake.payloadsReceived.get(1);
        assertEquals("request_received", firstInvocationRequestReceivedPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-623ea48b2fcd64aa41a188f486cbce10d11817db-4e2178d1d6a088d306ed40e1c773a618a767d36a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationRequestReceivedPayload.getString("execution_index"));
        assertEquals(0, firstInvocationRequestReceivedPayload.getInt("generated_id"));
        firstInvocationRequestReceivedPayload = null;

        JSONObject secondInvocationPayload = FilibusterServerFake.payloadsReceived.get(2);
        assertEquals("invocation", secondInvocationPayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-623ea48b2fcd64aa41a188f486cbce10d11817db-4e2178d1d6a088d306ed40e1c773a618a767d36a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1], [\"V1-7c211433f02071597741e6ff5a8ea34789abbf43-02be70093aa1244da10bd3b32514e8b3233ac30e-293f9d04b223505c718930ae5136455de9476400-1457c6f32cd01e387cfce1b8e17cdf8ac54887bf\", 1]]", secondInvocationPayload.getString("execution_index"));
        assertEquals(secondRequestVectorClock.toJSONObject().toString(), secondInvocationPayload.getJSONObject("vclock").toString());
        secondInvocationPayload = null;
        ...
        assertEquals("invocation_complete", firstInvocationCompletePayload.getString("instrumentation_type"));
        assertEquals("[[\"V1-aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d-623ea48b2fcd64aa41a188f486cbce10d11817db-4e2178d1d6a088d306ed40e1c773a618a767d36a-3c1cee3739e0ed5d0c169309c4a17650cd7fb4a4\", 1]]", firstInvocationCompletePayload.getString("execution_index"));
        assertEquals(firstRequestVectorClock.toJSONObject().toString(), firstInvocationCompletePayload.getJSONObject("vclock").toString());
        assertEquals(0, firstInvocationCompletePayload.getInt("generated_id"));
        firstInvocationCompletePayload = null;
