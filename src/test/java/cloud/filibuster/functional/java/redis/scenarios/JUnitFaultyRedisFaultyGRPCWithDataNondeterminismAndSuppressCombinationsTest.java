...
public class JUnitFaultyRedisFaultyGRPCWithDataNondeterminismAndSuppressCombinationsTest extends JUnitAnnotationBaseTest {
    static StatefulRedisConnection<String, String> statefulRedisConnection;
    static String redisConnectionString;
    private static final Logger logger = Logger.getLogger(JUnitFaultyRedisFaultyGRPCWithDataNondeterminismAndSuppressCombinationsTest.class.getName());
