...
public final class StringByzantineValueTransformer implements Transformer<String, Integer> {
    private boolean hasNext = true;
    private String result;
    private Accumulator<String, Integer> accumulator;
    private static final String[] possibleValues = {null, "123", "", "abcd", "-123ABC", "ThisIsATestString"};

    @Override
    @CanIgnoreReturnValue
    public StringByzantineValueTransformer transform(String payload, Accumulator<String, Integer> accumulator) {
