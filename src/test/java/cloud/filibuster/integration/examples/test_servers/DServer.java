...
import algorithmjacob.jacobservices.MyDService;
...
public class DServer {
    final private static String serviceName = "D";
    ...
    public static Server serve() {
        ...
        ServerServiceDefinition interceptService = ServerInterceptors.intercept(new MyDService(), List.of(new FilibusterServerInterceptor(serviceName), new FilibusterServerInvocationInterceptor()));
