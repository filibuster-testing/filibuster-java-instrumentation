...
public class FaultyRedisFaultyGRPCWithDataNondeterminismTest extends JUnitAnnotationBaseTest {
    static StatefulRedisConnection<String, String> statefulRedisConnection;
    static String redisConnectionString;
    private static final Logger logger = Logger.getLogger(FaultyRedisFaultyGRPCWithDataNondeterminismTest.class.getName());
    ...
    @DisplayName("Tests the scenario where faults are injected in both Redis and the GRPC client. GRPC calls are issued before and after the Redis call. " +
            "DataNonDeterminism is set to true while suppressCombinations is false")
    @Order(1)
    @TestWithFilibuster(
