...
public class FilibusterGrpcBasicAnalysisWithSleepDeferConfigurationFile implements FilibusterAnalysisConfigurationFile {
    ...
    private static Map<String, String> createGrpcErrorMap(String code) {
        ...
        myMap.put("cause", "");
        myMap.put("code", code);
        myMap.put("defer", "true");
        myMap.put("sleep", "10000");
        return myMap;
    }
