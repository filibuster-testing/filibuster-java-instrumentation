...
public class CServer {
    ...
    public static Server serve() {
        ...
        ServerServiceDefinition interceptService = ServerInterceptors.intercept(new MyCService(), List.of(new FilibusterServerInterceptor(serviceName), new FilibusterServerInvocationInterceptor()));
