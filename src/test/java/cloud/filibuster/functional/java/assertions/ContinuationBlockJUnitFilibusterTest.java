...
public class ContinuationBlockJUnitFilibusterTest extends JUnitAnnotationBaseTest {
    private final static Set<String> testExceptionsThrown = new HashSet<>();

    private static int numberOfTestExecutions = 0;

    private static int numberOfContinuationInvocations = 0;
    ...
    public void testMyHelloAndMyWorldServiceWithFilibuster() throws Throwable {
        ...
        assertPassesAndThrowsOnlyUnderFault(() -> {
            ...
            numberOfContinuationInvocations++;
        });
    ...
    @DisplayName("Verify correct number of invocations of the continuation.")
    @Test
    @Order(2)
    public void testNumberOfContinuationInvocations() {
        // Continution should only ever be reached once: in the execution where we do not inject a fault.
        assertEquals(1, numberOfContinuationInvocations);
    }
